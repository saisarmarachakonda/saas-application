...
export default function ERPPage() {
  ...
  // Pagination State for 364 ERP Records
  ...
  const handleSyncERP = () => {
    ...
    setTimeout(() => {
      setSyncStatus('Success: ERP database fully synchronized across 4 multi-plant nodes.');
  ...
  const handleExportERP = () => {
    const docData = {
      code: 'ERP-SUMMARY-2026',
      name: 'Enterprise Resource Planning Audit',
      designation: 'MRP & Capacity Manager',
      department: 'ERP Operations',
      site: 'Global Multi-Plant Network',
      phone: '+91 9876543210',
      aadhaar: 'ERP-AUDIT-PASSED',
      pan: 'CORP-PAN-ERP',
      uan: '100099990000',
      esi: 'ACTIVE ERP SYNC',
      bank: 'ERP-LEDGER-ACC-01',
      ifsc: 'SBIN0009999',
      joiningDate: '2026-08-06',
      status: 'Synchronized'
    };
    downloadPdfDocument('ERP Resource Planning', docData);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        <div className="glass-card p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold tracking-wider text-slate-400">ERP Ledger Sync SLA</span>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <span>Material Requirements Planning (MRP II) Work Order Schedule ({filteredOrders.length} Records)</span>
            </h3>
