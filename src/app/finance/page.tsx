...
export default function ComprehensiveFinancePage({ initialTab }: { initialTab?: string }) {
              ...
              {reportSubTab === 'pl' && (
                <div className="glass-card p-6 rounded-xl border border-slate-200 dark:border-slate-800 space-y-4 w-full max-w-none">
                  <div className="text-center pb-4 border-b border-slate-200 dark:border-slate-800">
                    <h2 className="text-base font-extrabold uppercase text-slate-800 dark:text-slate-200">VOC Enterprise Infra</h2>
